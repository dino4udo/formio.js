...
(function (undefined) {
    ...
    ! function (e, r) {
        ...
        function e(e) {
            ...
            const r = Math.round(Math.log(e) * Math.LOG10E);
            return r - (Number('1e' + r) > e);
        }

        function r(e) {
            for (const t in e)(e instanceof r || Me.call(e, t)) && Ie(this, t, {
                value: e[t],
                enumerable: !0,
                writable: !0,
                configurable: !0,
        ...
        function n() {
            ...
            s ? (s = s.replace(n, '\\$&'), a = a.replace(s, '(' + s + ')')) : a = '()' + a, Ge.call(i, a.slice(0, a.indexOf('(') + 1)), a = a.slice(a.indexOf('(') + 1);
                ...
                const c = new RegExp(l, e.multiline ? 'gm' : 'g');
        ...
        function f(e) {
            ...
            for (let i = 1, o = t.length; i < o; i++) Me.call(ur.subtags, t[i]) ? t[i] = ur.subtags[t[i]] : Me.call(ur.extLang, t[i]) && (t[i] = ur.extLang[t[i]][0], 1 === i && ur.extLang[t[1]][1] === t[0] && (t = qe.call(t, i++), o -= 1));
            return Ze.call(t, '-');
        }
        ...
        function d(e) {
            ...
            for (let n = a(e), i = s(n.length), o = 0; o < i;) {
                const l = String(o),
                    c = l in n;
                if (c) {
                    const u = n[l];
        ...
        function j(e, t, n) {
            ...
            for (const s in o) Me.call(o, s) && Ie(o, s, {
                writable: !1,
                configurable: !1,
                value: o[s],
            });
        ...
        function F(e, i, o) {
            ...
            g['[[localeMatcher]]'] = f;
            const m = $e.NumberFormat['[[localeData]]'],
            ...
            const j = D(o, 'currencyDisplay', 'string', new t('code', 'symbol', 'name'), 'symbol');
            'currency' === y && (s['[[currencyDisplay]]'] = j);
            const k = z(o, 'minimumIntegerDigits', 1, 21, 1);
            s['[[minimumIntegerDigits]]'] = k;
            const O = 'currency' === y ? x : 0,
                F = z(o, 'minimumFractionDigits', 0, 20, O);
            s['[[minimumFractionDigits]]'] = F;
            const L = 'currency' === y ? Math.max(F, x) : 'percent' === y ? Math.max(F, 0) : Math.max(F, 3),
                P = z(o, 'maximumFractionDigits', F, 20, L);
            s['[[maximumFractionDigits]]'] = P;
            let N = o.minimumSignificantDigits,
            ...
            const _ = D(o, 'useGrouping', 'boolean', void 0, !0);
            s['[[useGrouping]]'] = _;
            const M = m[p],
                I = M.patterns,
                A = I[y];
        ...
        function E() {
            const e = null !== this && 'object' === Ne.typeof(this) && l(this);
        ...
        function L() {
            const e = arguments.length <= 0 || void 0 === arguments[0] ? void 0 : arguments[0],
      ...
      for (var u = new t, g = c.indexOf('{', 0), f = 0, m = 0, v = c.length; g > -1 && g < v;) {
          ...
          if (g > m) {
              const d = c.substring(m, g);
              Ge.call(u, {
                  '[[type]]': 'literal',
                  '[[value]]': d,
              });
          }
          const h = c.substring(g + 1, f);
          if ('number' === h)
              if (isNaN(r)) {
                  const p = s.nan;
                  Ge.call(u, {
      ...
      return u;
        ...
        function _(r, t, n) {
            ...
            if (0 === r) i = Ze.call(Array(a + 1), '0'), o = 0;
                ...
                o = e(Math.abs(r));
                const s = Math.round(Math.exp(Math.abs(o - a + 1) * Math.LN10));
            ...
            if (o >= 0 ? i = i.slice(0, o + 1) + '.' + i.slice(o + 1) : o < 0 && (i = '0.' + Ze.call(Array(-(o + 1) + 1), '0') + i), i.indexOf('.') >= 0 && n > t) {
                for (let l = n - t; l > 0 && '0' === i.charAt(i.length - 1);) i = i.slice(0, -1), l--;
        ...
        function M(e, r, t, n) {
            ...
            if (0 !== a) {
                let u = o.length;
                if (u <= a) {
                    const g = Ze.call(Array(a + 1 - u + 1), '0');
                    o = g + o, u = a + 1;
                }
                const f = o.substring(0, u - a),
                    m = o.substring(u - a, o.length);
                o = f + '.' + m, c = f.length;
            }
            else c = o.length;
            for (let v = n - t; v > 0 && '0' === o.slice(-1);) o = o.slice(0, -1), v--;
            if ('.' === o.slice(-1) && (o = o.slice(0, -1)), c < r) {
                const d = Ze.call(Array(r - c + 1), '0');
                o = d + o;
            }
            return o;
        }
        ...
        function I(e) {
            for (let r = 0; r < wr.length; r += 1)
                if (e.hasOwnProperty(wr[r])) return !1;
            return !0;
        }

        function A(e) {
            for (let r = 0; r < br.length; r += 1)
        ...
        function R(e, r) {
            ...
            for (let a = 0; a < wr.length; a += 1) r[wr[a]] && (t[wr[a]] = r[wr[a]]), r._[wr[a]] && (t._[wr[a]] = r._[wr[a]]);
            return t;
        }

        function q(e) {
            return e.pattern12 = e.extendedPattern.replace(/'([^']*)'/g, (e, r) => {
                return r ? r : '\'';
        ...
        function G(e, r) {
            if (!yr.test(r)) {
                ...
                return t.extendedPattern = r.replace(hr, e => {
                    return C(e, t._);
                }), e.replace(hr, e => {
                    return C(e, t);
                }), q(t);
        ...
        function U(e, r, t, n, a) {
            const i = e[r] && e[r][t] ? e[r][t] : e.gregory[t],
                o = {
                    narrow: [ 'short', 'long' ],
                    short: [ 'long', 'narrow' ],
                    long: [ 'short', 'narrow' ],
                ...
                for (const v in Dr)
                    if (Me.call(Dr, v)) {
                        ...
                        if (void 0 === d && void 0 !== h) m -= n;
                            ...
                            const p = [ '2-digit', 'numeric', 'narrow', 'short', 'long' ],
                                y = Ae.call(p, d),
                                b = Ae.call(p, h),
        ...
        function X(e, r) {
            const t = [];
            for (const n in Dr) Me.call(Dr, n) && void 0 !== e['[[' + n + ']]'] && t.push(n);
            if (1 === t.length) {
                const a = B(t[0], e['[[' + t[0] + ']]']);
                if (a) return a;
            }
                ...
                for (const b in Dr)
                    if (Me.call(Dr, b)) {
                        ...
                        if (w !== j && (y -= g), void 0 === w && void 0 !== x) y -= o;
                            ...
                            const D = [ '2-digit', 'numeric', 'narrow', 'short', 'long' ],
                                z = Ae.call(D, w),
                                k = Ae.call(D, x),
        ...
        var ae = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (e) {
            ...
            ie = function () {
                ...
                return function (r, t, n, a) {
                    const i = r && r.defaultProps,
                        o = arguments.length - 3;
                    if (t || 0 === o || (t = {}), t && i)
                        for (const s in i) void 0 === t[s] && (t[s] = i[s]);
                    else t || (t = i || {});
                    if (1 === o) t.children = a;
                    else if (o > 1) {
                ...
                return function () {
                    ...
                    return new Promise((e, t) => {
                        function n(a, i) {
                            ...
                            return o.done ? void e(s) : Promise.resolve(s).then(e => {
                                return n('next', e);
                            }, e => {
                                return n('throw', e);
                            });
            ...
            ue = function (e, r) {
                for (let t = Object.getOwnPropertyNames(r), n = 0; n < t.length; n++) {
                    const a = t[n],
            ...
            we = function (e, r) {
                const t = {};
                for (const n in e) r.indexOf(n) >= 0 || Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
                return t;
            },
            xe = function (e, r) {
        ...
        'get' in t && e.__defineGetter__ ? e.__defineGetter__(r, t.get) : (!Me.call(e, r) || 'value' in t) && (e[r] = t.value);
            ...
            Ae = Array.prototype.indexOf || function (e) {
                ...
                for (let t = arguments[1] || 0, n = r.length; t < n; t++)
                    if (r[t] === e) return t;
                return -1;
            },
            Re = Object.create || function (e, r) {
                ...
                for (const a in r) Me.call(r, a) && Ie(n, a, r[a]);
                return n;
            },
        ...
        Ie(mr.NumberFormat.prototype, 'resolvedOptions', {
            ...
            value () {
                ...
                for (let i = 0, o = n.length; i < o; i++) Me.call(a, e = '[[' + n[i] + ']]') && (t[n[i]] = {
                    value: a[e],
                    writable: !0,
                    configurable: !0,
                    enumerable: !0,
        ...
        const zr = mr.__localeSensitiveProtos = {
            Number: {},
            Date: {},
        };
        if (zr.Number.toLocaleString = function () {
            ...
            value () {
                ...
                for (const e in zr.Date) Me.call(zr.Date, e) && Ie(Date.prototype, e, {
                    writable: !0,
                    configurable: !0,
                    value: zr.Date[e],
                });
